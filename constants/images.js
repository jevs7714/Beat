...
import beatLogo from "../assets/images/beatlogo.png";

export default {
    profile, thumbnail, cards, path, logo, logoSmall, empty, logoConso, appsPic, CAnimate, mario, coverGames, buddy, clyde, don, choi2, patrick, nano, jam,
    Tima, Time, calling, appLogo, beat, beatLogo
};
